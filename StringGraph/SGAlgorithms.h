...
Edge* createEdgesFromOverlap(StringGraph* pGraph, const Overlap& o, bool allowContained, size_t maxEdges = -1,GraphColor c =0);
Edge* createScaffoldEdges(StringGraph* pGraph, std::string StartID, std::string EndID, std::string EC_comp, std::string ED_dir, size_t npair, size_t C1Pos, size_t C2Pos, GraphColor c);
