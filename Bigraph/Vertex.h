...
class Vertex
{
    public:
        ...
        // scaffold
        void mergeScaffold(size_t insertSize, Edge* pEdge, EdgeDir dir);
        ...
        // scaffold
        EdgePtrVec getEdgesBoth(EdgeDir dir) const;
        EdgePtrVec getEdgesSame(EdgeDir dir) const;
        EdgePtrVec getEdgesRev() const;
        EdgePtrVec getEdgesWith(EdgeDir dir, Vertex* pV) const;
        EdgePtrVec getEdgesWithout(Vertex* pV) const;
        EdgePtrVec getScaffoldEdges(EdgeDir dir, EdgeComp comp) const;
        size_t countEdges(EdgeDir dir, EdgeComp comp);
        size_t countScaffoldEdges(Vertex* pV);
        ...
        void setScaSeq(const std::string& s) { m_sca_seq = s; }
        std::string getScaSeq() const { return m_sca_seq; }
        void setScaffold(bool c) { m_isScaffold = c; }
        bool isScaffold() const { return m_isScaffold; }
        ...
        void writeScaffoldEdges(std::ostream& out, int dotFlags) const;
