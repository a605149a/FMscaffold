...
class Bigraph
{
    ...
    public:
        ...
        // scaffold
        void mergeScaffold(size_t insertSize, Vertex* pV1, Edge* pEdge, EdgeDir dir);
        ...
        void simplify();
        // scaffold
        void simplifyScaffold(size_t insertSize);
        ...
        bool visitP(VF& vf)
        {
            ...
            std::cout << "itvector.size = " << itvector.size() << std::endl;
        ...
        void writeScaffoldDot(const std::string& filename, int dotFlags = 0) const;
        void writeScaffoldASQG(const std::string& filename) const;
        
        // Write the graph with only Vertex(no edge) to an ASQG file
        void writeASQGonlyV(const std::string& filename) const;
    ...
    private:
        ...
        // scaffold
        size_t simplifyScaffold(size_t insertSize, Vertex* pV, EdgeDir dir);
